...
internal static class BuildPostprocessor 
{
    ...
    {
         string MobileGDPRLinksFile = "GDPRLinks";
         string MobilePurchaseIDSettingsFile = "PurchaseID";
         string MobileAdmobFile = "Settings";
         
         PurchaseIDHolder instancePurchase = Resources.Load<PurchaseIDHolder>(MobilePurchaseIDSettingsFile);
         GDPRLinksHolder instanceGDPRLinks = Resources.Load<GDPRLinksHolder>(MobileGDPRLinksFile);
         AdMobSettings instanceAdMobSettings = Resources.Load<AdMobSettings>(MobileAdmobFile);
