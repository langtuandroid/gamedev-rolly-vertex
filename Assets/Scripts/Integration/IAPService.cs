...
namespace Integration
{
    public class IAPService : MonoBehaviour, IDetailedStoreListener 
    {
        ...
        public event Action OnUpdateDiamondsAmount;
        [SerializeField]
        ...
        private void CheckSubscriptionStatus()
        {
            if (IsInitialized())
            {
                ...
                foreach (string productId in productIds)
                {
                    ...
                    SetSubscriptionPrice(productId);
                    try
                    {
        ...
        private void SetSubscriptionPrice(string subscriptionID)
        {
            ...
            if (product != null)
            {
                ...
                if (subscriptionID == _subscriptionMonthProductID)
                {
